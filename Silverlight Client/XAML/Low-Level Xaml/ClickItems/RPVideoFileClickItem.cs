...
{
    public class RPVideoFileClickItem : ClickItem
    {
        // Members
        ...
        public RPVideoFileClickItem(int index, RPPictureItem picItem, RPPictureClickItemTextFormat format, ClickItemLayouts layout)
            : this(index, picItem, format, layout, 120, 90)
        { }
        public RPVideoFileClickItem(int index, RPPictureItem picItem, RPPictureClickItemTextFormat format, ClickItemLayouts layout, double _Width, double _Height)
            : this()
        {
